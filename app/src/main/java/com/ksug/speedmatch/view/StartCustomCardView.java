...
public class StartCustomCardView extends LinearLayout {
    ...
    public StartCustomCardView(Context context) {
        this(context, null);
    }

    public StartCustomCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (inflater != null) {
            inflater.inflate(R.layout.start_view_custom_card, this, true);
        }
